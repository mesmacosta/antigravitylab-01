...
1. Act as the **SRE** (@sre) from `.agents/agents.md`.
2. Execute the `setup-cloud-build` skill to create the CI/CD pipeline.
3. Execute the `apply-cloud-armor` skill to set up WAF protection.
4. Execute the `canary-deploy` skill for safe traffic splitting.
